  ...
  <g>
    <g class="boxplot">
      ...
      <line
        ...
        @mouseover="onMouseOver($event, `W1: ${data.dist.w1}`)"
      ...
      <line
        ...
        :y2="yScale(data.dist.w2)"
        class="boxplot__whisker-q"
        @mouseover="onMouseOver($event, `W2: ${data.dist.w2}`)"
        @mouseleave="onMouseLeave"
      />
      <line
        :x1="0"
        ...
        @mouseover="onMouseOver($event, `Std dev 1: ${data.dist.sd1}`)"
        @mouseleave="onMouseLeave"
      />
      <line
        :x1="0"
        ...
        class="boxplot__whisker-stdev"
        @mouseover="onMouseOver($event, `Std dev 2: ${data.dist.sd2}`)"
        @mouseleave="onMouseLeave"
      />
      <rect
        :x="0"
        ...
        :height="boxHeight"
        class="boxplot__box"
        @mouseover="onMouseOver($event, `IQR: ${data.dist.q3}`)"
        @mouseleave="onMouseLeave"
      />
      <line
        :x1="0"
        ...
        @mouseover="onMouseOver($event, `Median: ${data.dist.median}`)"
        @mouseleave="onMouseLeave"
      />
      <line
        :x1="0"
        ...
        class="boxplot__mean"
        @mouseover="onMouseOver($event, `Mean: ${data.dist.mean}`)"
        @mouseleave="onMouseLeave"
      />
    </g>
    ...
    <circle
      ...
      @mouseover="onMouseOver($event, outlier)"
      @mouseleave="onMouseLeave"
    />
  </g>
</template>
